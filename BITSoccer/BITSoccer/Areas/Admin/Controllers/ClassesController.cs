...
namespace BITSoccer.Areas.Admin.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.RangeAgeID = new SelectList(db.RangeAges, "RangeAgeID", "RangeAgeID");
        ...
        public ActionResult Create([Bind(Include = "Class_ID,Name,MetaTitle,Quanity,Prices,PromoPrices,Image,StartDay,EndDay,MinQuanity,CreatedDate,CreatedBy,ModifyDate,ModifyBy,IsActive,ViewCount,Coach_ID,LevelStudentID,RangeAgeID,PartOfDayID,GenderID,RangeTimeID,StadiumID,Description,PictureUpload")] Class @class)
        {
            ...
            ViewBag.RangeAgeID = new SelectList(db.RangeAges, "RangeAgeID", "RangeAgeID", @class.RangeAgeID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Class_ID,Name,MetaTitle,Quanity,Prices,PromoPrices,Image,StartDay,EndDay,MinQuanity,CreatedDate,CreatedBy,ModifyDate,ModifyBy,IsActive,ViewCount,Coach_ID,LevelStudentID,RangeAgeID,PartOfDayID,GenderID,RangeTimeID,StadiumID,Description,PictureUpload")] Class @class)
        {
            if (@class.PictureUpload != null)
            {
                string fileName = Path.Combine(Server.MapPath("~/Content/Images"), Path.GetFileName(@class.PictureUpload.FileName));
